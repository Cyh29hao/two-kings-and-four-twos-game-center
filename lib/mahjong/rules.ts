...
export const HAM: ModernRules = {...HAM_V3,id:'ham-v4',version:4,closedBonus:false,forbidWildDiscard:true,fourWildWin:true,revealSeconds:15};
export const hamRulePreset=(id:string)=>[HAM,HAM_V3,HAM_V2,HAM_V1].find(r=>r.id===id);
