...
try {
  ...
  assert.equal(preview.game.actionPreview.minRaise,'31');
  ...
  assert.equal(preview.game.actionPreview.betStep,'1');
  ...
  assert.equal(updated.game.actionPreview.minRaise,'101');
