...
function PlayerZone({g,index,position,seconds,own=false,botControls}:{g:MahjongView;index:number;position:string;seconds:number;own?:boolean;botControls?:BotSeatControls}){
