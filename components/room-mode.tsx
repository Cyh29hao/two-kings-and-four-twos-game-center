...
export function PracticeBanner({mahjong=false}:{mahjong?:boolean}){return <div className="practice-banner"><Bot size={20}/><div><b>人机测试 · 进阶陪练</b><span>{mahjong?'本桌筹码与战报正常保留，不影响账号积分。':'本局照常计算输赢，不累计到账号积分。'}机器人只使用自己手牌与公开信息。</span></div></div>}
